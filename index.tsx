                  ...
                  <div key={hack.id} className="bg-white rounded-2xl shadow-xs overflow-hidden border border-slate-100 flex flex-col hover:shadow-2xl transition-all duration-300 shimmer-card transform hover:-translate-y-2">
                    <div className="relative w-full h-48 sm:h-52 overflow-hidden bg-white border-b border-slate-100 flex items-center justify-center">
                      <img 
                        src={hack.thumbnail} 
                        alt={hack.title} 
                        className="w-full h-full object-fill hover:scale-105 transition-transform duration-500 ease-out"
                  ...
                  <div key={evt.id} className="bg-white rounded-2xl shadow-xs overflow-hidden border border-slate-100 flex flex-col hover:shadow-2xl transition-all duration-300 shimmer-card transform hover:-translate-y-2">
                    ...
                    <div className="p-5 flex flex-col flex-grow">
                      ...
                      <a 
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="w-full mt-auto py-2.5 bg-purple-600 text-white rounded-xl text-xs font-bold hover:bg-purple-700 transition-all text-center shadow-md flex items-center justify-center gap-1.5"
                      >

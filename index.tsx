              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
                {filteredHackathons.map((hack) => (
                  <div key={hack.id} className="bg-white rounded-2xl shadow-xs overflow-hidden border border-slate-100 flex flex-col hover:shadow-2xl transition-all duration-300 shimmer-card transform hover:-translate-y-2">
                    <div className="relative w-full h-48 sm:h-52 overflow-hidden bg-slate-900 border-b border-slate-100 flex items-center justify-center">
                      <img 
                        src={hack.thumbnail} 
                        alt={hack.title} 
                        className="w-full h-full object-contain p-2 hover:scale-105 transition-transform duration-500 ease-out"

    ...
    <div className="min-h-screen flex flex-col relative overflow-hidden bg-slate-50">
      ...
      {view === 'virtual-internship' && (
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-gradient-to-br from-indigo-50 to-blue-50 rounded-2xl p-8 border border-indigo-100">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-xl font-black text-indigo-900">Cloud-Based CRM System</h3>
                </div>
                <p className="text-slate-600 mb-4 leading-relaxed">
                  Build a comprehensive Customer Relationship Management system with cloud infrastructure. Perfect for demonstrating enterprise-level development skills.
                </p>
                <ul className="space-y-2 text-sm text-slate-700">
                  <li> AWS cloud infrastructure deployment</li>
                  <li> React.js frontend with Material-UI</li>
                  <li> Node.js backend with microservices</li>
                  <li> PostgreSQL with Redis caching</li>
                  <li> Real-time notifications with WebSocket</li>
                </ul>
              </div>
              <div className="bg-gradient-to-br from-violet-50 to-purple-50 rounded-2xl p-8 border border-violet-100">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-xl font-black text-violet-900">IoT Smart Home Dashboard</h3>
                </div>
                <p className="text-slate-600 mb-4 leading-relaxed">
                  Develop an IoT-enabled smart home management system with real-time monitoring and control. Ideal for showcasing hardware integration and full-stack skills.
                </p>
                <ul className="space-y-2 text-sm text-slate-700">
                  <li> Raspberry Pi/Arduino integration</li>
                  <li> MQTT protocol for device communication</li>
                  <li> React dashboard with real-time data</li>
                  <li> Node-RED for automation workflows</li>
          ...
          <div className="bg-gradient-to-r from-indigo-900 to-violet-900 rounded-[3rem] p-12 text-white mb-20">
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-xl text-indigo-200 mb-12 text-center">
                Complete toolkit for remote internship success
              </p>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
                  ...
                  <ul className="space-y-2 text-indigo-200">
                    <li> Remote learning best practices</li>
                    <li> Virtual collaboration tools</li>
                    <li> Cloud development environments</li>
                    <li> Video tutorials and workshops</li>
                    <li> Digital documentation library</li>
                  </ul>
                </div>
                <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
                  <div className="w-16 h-16 bg-violet-600 rounded-xl flex items-center justify-center mb-4">
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
                  ...
                  <ul className="space-y-2 text-indigo-200">
                    <li> Remote work skills training</li>
                    <li> Digital portfolio creation</li>
                    <li> Online networking strategies</li>
                    <li> Virtual interview preparation</li>
                    <li> Remote job placement support</li>
                  </ul>
                </div>
              </div>
            </div>
